...
public class SubStackMaker {
	 ...
	 * Usage: makeSubStack(univ.getImage(), input);
	 ---
	 * Makes a substack with given hyphenated input (i.e., 2-3),
	 * to make a substack with the slice range, inclusive.
	 */
	...
	/* Function: makeSubStack
	 * Usage: imp2 = stackList(imp, count, numList, stackTitle);
	 ---
	 * Helper method for makeSubStack; extract specific slices.
	 */
	...
	/* Function: stackRange
	 * Usage: imp2 = stackRange(imp, first, last, inc, stackTitle);
	 ---
	 * Helper method for makeSubStack; extracts range of slices.
	 */
